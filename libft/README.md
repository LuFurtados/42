...
### 3. Bonus Functions - Linked Lists (Part 3)
An optional extension implementing a dynamic single linked list data structure utilizing the `t_list` layout:
...
* `make bonus` : Compiles both the mandatory and linked list bonus functionalities into the archive.
...
To incorporate this library into your custom external projects, compile your primary source file with the archive header reference:
